...
if not future.empty:
    ...
    period_hours = st.slider("Cheapest period length (hours)", min_value=1, max_value=6, value=1, key="cheapest_period_hours")
...
st.caption("Prices in øre/kWh. Refreshes once daily shortly after 14:00.")area_df = df[df["PriceArea"] == area].sort_values("HourDK")
